...
import com.sakura.artifact.util.IDLSkillNBT;
import com.sakura.artifact.util.MessageDef;
...
import static com.sakura.artifact.util.CommonFunctions.SendMsgToPlayer;
                ...
                if (hand == EnumHand.MAIN_HAND) {
                    if (mainHandCast) {
                        ...
                        if (casterIsPlayer)
                        {
                            ...
                            ActFramework.LogWarning("Trying to do invalid cast from a creature: %s", caster.getName());
                        }
                    }
