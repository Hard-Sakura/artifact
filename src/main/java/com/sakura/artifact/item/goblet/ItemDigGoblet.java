...
public class ItemDigGoblet extends ItemGobletBase {
    ...
    public String GetStoredBlockName(ItemStack stack)
    {
        ...
        return compound == null ? "" : compound.getString(IDLNBTDef.ASSIGNED_BLOCK_NAME);
    }

    public void SetStoredBlockName(ItemStack stack, Block block)
    {
        ResourceLocation resourceLocation = block.getRegistryName();
        IDLNBTUtil.SetString(stack, IDLNBTDef.ASSIGNED_BLOCK_NAME, resourceLocation==null ? "" : block.getRegistryName().toString());
    }
