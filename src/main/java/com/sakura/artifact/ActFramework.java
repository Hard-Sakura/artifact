package com.sakura.artifact;

import com.sakura.artifact.gui.ModGuiElementLoader;
import com.sakura.artifact.init.ModConfig;
import com.sakura.artifact.init.ModRecipes;
import com.sakura.artifact.init.ModSpawn;
import com.sakura.artifact.init.RegistryHandler;
import com.sakura.artifact.keys.KeyboardManager;
import com.sakura.artifact.meta.MetaUtil;
import com.sakura.artifact.network.NetworkHandler;
import com.sakura.artifact.proxy.ProxyBase;
import com.sakura.artifact.util.CommonDef;
...
@Mod(modid = ActFramework.MODID, name = ActFramework.NAME, version = ActFramework.VERSION)//dependencies = "required-after:Forge@[14.23.5.2705,)"
public class ActFramework {
    ...
    @Mod.Instance
    public static ActFramework instance;
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        MetaUtil.isIDLLoaded = Loader.isModLoaded("artifact");
    ...
    private void TrashTalking() {
        ...
        {
            ActFramework.Log("[artifact Framework] Bow to artifact.");
        }
        else {
            ActFramework.Log("[artifact Framework] Made with artifact Framework.");
        }
    }
