package com.sakura.artifact.gui;

import com.sakura.artifact.ActFramework;
import com.sakura.artifact.gui.expOne.ContainerDemo;
import com.sakura.artifact.gui.expOne.GuiContainerDemo;
...
public class ModGuiElementLoader implements IGuiHandler {
    ...
    {
        NetworkRegistry.INSTANCE.registerGuiHandler(ActFramework.instance, this);
    }
