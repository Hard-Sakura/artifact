package com.sakura.artifact.enchantments;
...
public class ModEnchantmentInit {
    ...
    /**附魔，参数(名字，稀有度，附魔类型，有效装备栏)*/
    public static final ModEnchantmentBase MODETEST = new ModEnchantmentBase("artifact.duang_boom", Enchantment.Rarity.COMMON, EnumEnchantmentType.WEAPON,  mainHand);

    public static final ModEnchantmentBase MODETEST1 = new ModEnchantmentBase("artifact.duang_boom1", Enchantment.Rarity.COMMON, EnumEnchantmentType.WEAPON,  mainHand);
